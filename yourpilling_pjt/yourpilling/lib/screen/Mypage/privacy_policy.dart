        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Container(
                child: Text("앱에서 사용하는 제3자 서비스 제공업체의 개인정보 보호정책 링크", style: TextStyle(
                  fontSize: 14,
                  fontWeight: FontWeight.w400,
                  fontFamily: "Pretendard",
                ),),
              ...
              Container(
                child: Text(
                    "   우리는 이 서비스 사용자에게 이러한 제3자가 사용자의 개인정보에 접근할 수 있음을 알리고 싶습니다. 그 이유는 우리를 대신하여 그들에게 할당된 임무를 수행하기 위해서입니다. 그러나 해당 정보를 다른 목적으로 공개하거나 사용해서는 안 됩니다.", style: TextStyle(
                  fontSize: 25,
                  fontWeight: FontWeight.w400,
                  fontFamily: "Pretendard",
                ),),
